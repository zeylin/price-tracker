...
public class City extends TableImpl<CityRecord> {
    ...
    private static final long serialVersionUID = 905419059;
     ...
     */
    public final TableField<CityRecord, Integer> CITY_ID = createField(DSL.name("city_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.city.name</code>.
     */
    public final TableField<CityRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.city.country</code>.
     */
    public final TableField<CityRecord, String> COUNTRY = createField(DSL.name("country"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public List<UniqueKey<CityRecord>> getKeys() {
        return Arrays.<UniqueKey<CityRecord>>asList(Keys.CITY_PKEY, Keys.CITY_NAME_KEY);
    }
